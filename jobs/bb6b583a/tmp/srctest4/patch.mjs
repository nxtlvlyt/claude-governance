...
// generated via json.dumps (proven serializer) after two hand-escaped attempts broke on
// JS template-literal backslash rules -- ANCHOR REQUIREMENT below is the actual fix.
