...
export function lintMission(text) {
  ...
  //   (b) the mission carries a fenced shell/pwsh/bash block anywhere (  ck(lintMission(d1Mission).ok, 'RULE 8: "wrangler d1 execute" is a data command, never flagged as a deploy-without-commit');
