...
| 3 — Governance chain | 32GB+ | Tier 2 + gemma4:26b (MoE), qwen3.6:27b (MoE), laguna-xs-2.1:q8_0 (v-swap 2026-07-02, was xs.2), nemotron-cascade-2 | ✓ Yes — laguna enables surrender-check |
| 4 — The Factory | 128GB+ | Tier 3 + granite4.1:30b, nemotron-3-super, gemma4:31b | ✓ Yes — full chain |

**Tiers 1 and 2 have no substrate edit authorization.** laguna-xs-2.1:q8_0 (v-swap 2026-07-02, was xs.2) requires ~28GB RAM and cannot run on those tiers. The surrender-check gate will block Edit/Write on governance files. Tier 1–2 users operate the full framework (hooks, canon, session-start) and can use cloud models for deliberation, but cannot make governed substrate edits without a Tier 3+ machine.
...
ollama pull laguna-xs-2.1:q8_0 (v-swap 2026-07-02, was xs.2)        # ~28GB — governance witness, substrate edit authorization
