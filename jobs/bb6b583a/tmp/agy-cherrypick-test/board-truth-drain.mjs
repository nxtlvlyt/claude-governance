...
// Ports the proven Claude-workflow pattern (the parent jurisdiction's board-truth-drain.js
// workflow, 19/19 refute-upheld on 2026-07-07's gap-#7 drain) off the Claude harness so ANY
