...
Write-Output ("BEFORE OLLAMA_NUM_GPU User=" + [Environment]::GetEnvironmentVariable('OLLAMA_NUM_GPU','User'))
...
Write-Output ("AFTER  OLLAMA_NUM_GPU User=" + [Environment]::GetEnvironmentVariable('OLLAMA_NUM_GPU','User'))
