...
**Struck so far (2026-07-04, this session): 9 of the 25 hunt items** — #2 (local-lane
...
divergence guard fail-open-on-git-error, 6c1363a). None of the 4 top-level items (#7-10) are
...
**20 remain open** (4 top-level + 16 hunt items).
