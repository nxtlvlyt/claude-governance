...
**2026-07-05 progress**: 4 cells run so far (simple correctness smoke-test, real /api/ps GR10
check before each dispatch, no forcing): qwen3.6:27b -> correct, qwen3.6:35b -> correct,
north-mini-code-toolcall:latest -> correct, north-mini-code-1.0:q8_0 -> correct. Each
dispatched serially, yielding whenever the lane was occupied (including by the prior
...
naturally-idle lane counts. Still UNRUN: north-mini-code-1.0:q4_K_M, ornith:9b, ornith:35b —
