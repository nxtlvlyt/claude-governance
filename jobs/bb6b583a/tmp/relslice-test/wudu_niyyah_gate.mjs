...
if (process.argv[1] && process.argv[1].endsWith('wudu_niyyah_gate.mjs')) {
  ...
  const REQ_A = 'C:/Users/marka/.claude/CLAUDE.md';
  const REQ_B = 'C:/Users/marka/.claude/practice/core.md';
  ...
  const fitsPath = 'C:/Users/marka/.claude/practice/extended/pillars-and-sunnah.md';
  ...
  const longPath = 'C:/Users/marka/.claude/practice/extended/some-very-long-governance-document-name-that-pushes-the-args-json-past-the-truncation-boundary.md';
