...
// FORK JURISDICTION (fork intake 1, 2026-07-08): this fork's rulebook is the agy/.agents
// AGENTS.md — the parent jurisdiction's practice/canon files are not read here. The parent's
// CANON-MANIFEST has no fork equivalent; the rulebook alone is the governance gate.
const GOV_FILES = ['~/.agents/AGENTS.md'];
